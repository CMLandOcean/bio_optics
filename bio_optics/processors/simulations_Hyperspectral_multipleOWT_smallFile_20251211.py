...
from bio_optics.models import hereon_orig as hereon
...
R_rs_sim.to_csv(outpath + "SimRrs_InsituForward_" + AlgaeGroupType + iopFnames[0], header=True, sep='\t', index=False)