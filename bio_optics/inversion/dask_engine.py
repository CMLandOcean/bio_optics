...
def invert(params,
    ...
    Designed for use with Dask parallelisation: accepts params as a serialised string
    (produced by lmfit Parameters.dumps()) because Dask cannot directly serialise
    lmfit Parameters objects.

    Args:
        params: serialised lmfit Parameters string (produced via params.dumps())
    ...
    """
    # Dask cannot serialise lmfit.Parameters; reconstruct from the serialised string
