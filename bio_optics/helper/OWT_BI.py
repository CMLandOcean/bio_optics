...
class OWT():
    ...
    def __init__(self, AVW, Area, NDI, fn = "./data_OWT_Bi/OWT_centroids.nc"):
        ...
        classInfo = self.load_centroids(fn)
    ...
    @staticmethod
    def load_centroids(fn):
        """
        load the centroids for classification
        For the "./data_OWT_Bi/OWT_centroids.nc" file, three variables included:
        ...
        """
        # fn = "./data_OWT_Bi/OWT_centroids.nc"
        # fn = "./data_OWT_Bi/OWT_centroids_refined3a_4a_final.nc"
        ds = nc.Dataset(fn)
