...
def forward(parameters,
    ...
    R_rs_adj = adjacency_effect.R_rs_adjacency(C_adj=parameters["C_adj"],
                                               wavelengths = wavelengths,
    ...
    R_rs_sim = air_water.below2above(water_alg.r_rs_shallow(r_rs_deep=rrsd, K_d=Kd, k_uW=kuW, zB=parameters["zB"], R_rs_b=Rrsb, k_uB=kuB)) + R_rs_adj# zeta & gamma
    ...
    if parameters["fit_surface"].value:
        ...
        return R_rs_sim + R_rs_surface + parameters["offset"]

    else:
        return R_rs_sim + parameters["offset"]
...
def forward_adjacency(parameters,
    ...
    Returns:
        _type_: _description_
    """
    R_rs_adjacency = adjacency_effect.R_rs_adjacency(C_adj=parameters["C_adj"], wavelengths=wavelengths, lambda_r=parameters["lambda_r"], b_r_spec=parameters["b_r_spec"], n_r=parameters["n_r"], R_bg=R_bg, b_ray=b_ray)
