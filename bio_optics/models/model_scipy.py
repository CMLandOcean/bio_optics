    ...
    def df_div_df_0():
        df_div_df_0 = air_water.dbelow2above_div_dp(R_rs_water,
                                                water_alg.drrs_shallow_div_dp(r_rs_deep=rrsd,
                                                                                ...
                                                                                dk_uW_div_dp=0,
                                                                                r_rs_b=Rrsb,
                                                                                d_r_rs_b_div_dp=bottom_reflectance.dRrs_b_div_df_i(0, wavelengths=wavelengths, R_b_i_res=R_b_i_res),
                                                                                k_uB=kuB,
                                                                                dk_uB_div_dp=0,
                                                                                zB=parameters["zB"]
                                                )
    ...
    def df_div_df_1():
        df_div_df_1 = air_water.dbelow2above_div_dp(R_rs_water,
                                                water_alg.drrs_shallow_div_dp(r_rs_deep=rrsd,
                                                                                ...
                                                                                dk_uW_div_dp=0,
                                                                                r_rs_b=Rrsb,
                                                                                d_r_rs_b_div_dp=bottom_reflectance.dRrs_b_div_df_i(1, wavelengths=wavelengths, R_b_i_res=R_b_i_res),
                                                                                k_uB=kuB,
                                                                                dk_uB_div_dp=0,
                                                                                zB=parameters["zB"]
                                                )
    ...
    def df_div_df_2():
        df_div_df_2 = air_water.dbelow2above_div_dp(R_rs_water,
                                                water_alg.drrs_shallow_div_dp(r_rs_deep=rrsd,
                                                                                ...
                                                                                dk_uW_div_dp=0,
                                                                                r_rs_b=Rrsb,
                                                                                d_r_rs_b_div_dp=bottom_reflectance.dRrs_b_div_df_i(2, wavelengths=wavelengths, R_b_i_res=R_b_i_res),
                                                                                k_uB=kuB,
                                                                                dk_uB_div_dp=0,
                                                                                zB=parameters["zB"]
                                                )
    ...
    def df_div_df_3():
        df_div_df_3 = air_water.dbelow2above_div_dp(R_rs_water,
                                                water_alg.drrs_shallow_div_dp(r_rs_deep=rrsd,
                                                                                ...
                                                                                dk_uW_div_dp=0,
                                                                                r_rs_b=Rrsb,
                                                                                d_r_rs_b_div_dp=bottom_reflectance.dRrs_b_div_df_i(3, wavelengths=wavelengths, R_b_i_res=R_b_i_res),
                                                                                k_uB=kuB,
                                                                                dk_uB_div_dp=0,
                                                                                zB=parameters["zB"]
                                                )
    ...
    def df_div_df_4():
        df_div_df_4 = air_water.dbelow2above_div_dp(R_rs_water,
                                                water_alg.drrs_shallow_div_dp(r_rs_deep=rrsd,
                                                                                ...
                                                                                dk_uW_div_dp=0,
                                                                                r_rs_b=Rrsb,
                                                                                d_r_rs_b_div_dp=bottom_reflectance.dRrs_b_div_df_i(4, wavelengths=wavelengths, R_b_i_res=R_b_i_res),
                                                                                k_uB=kuB,
                                                                                dk_uB_div_dp=0,
                                                                                zB=parameters["zB"]
                                                )
    ...
    def df_div_df_5():
        df_div_df_5 = air_water.dbelow2above_div_dp(R_rs_water,
                                                water_alg.drrs_shallow_div_dp(r_rs_deep=rrsd,
                                                                                ...
                                                                                dk_uW_div_dp=0,
                                                                                r_rs_b=Rrsb,
                                                                                d_r_rs_b_div_dp=bottom_reflectance.dRrs_b_div_df_i(5, wavelengths=wavelengths, R_b_i_res=R_b_i_res),
                                                                                k_uB=kuB,
                                                                                dk_uB_div_dp=0,
                                                                                zB=parameters["zB"]
                                                )
