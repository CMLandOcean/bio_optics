...
from .. models import bandratioIOPprediction
...
def forward(parameters,
    ...
    R_rs_water = lee.R_rs_deep(a=a_res, 
                               ...
                               Gp0=parameters["Gp0"],
                               Gp1=parameters["Gp1"]) +\
                 fluorescence.R_rs_fl(wavelengths=wavelengths,
                                     ...
                                     h_C_res=h_C_res) + \
                 fluorescence.R_rs_fl_phycocyanin(wavelengths=wavelengths,
    ...
    if parameters["fit_surface"].value:
            ...
            if len(E_d_res) == 0:
                E_d = downwelling_irradiance.E_d(E_dd, E_ds, parameters["fd_d"], parameters["fd_s"])
            else:
                E_d = E_d_res

            L_s = sky_radiance.L_s(parameters["fd_d"], parameters["g_dd"], E_dd, parameters["fd_s"], parameters["g_dsr"], E_dsr, parameters["g_dsa"], E_dsa)
...
def forward_IOPs(parameters,
    ...
    Returns:
        _type_: _description_
    """
    C_phy = np.sum([parameters["C_0"], parameters["C_1"], parameters["C_2"], parameters["C_3"], parameters["C_4"],
                    parameters["C_5"], parameters["C_6"], parameters["C_7"]])
    ...
    if len(a_d_res) == 0:
        a_d_res = absorption.a_d(wavelengths=wavelengths,
                                 ...
                                 a_bd_spec_res=a_bd_spec_res,
                                 a_md_spec_res=a_md_spec_res)
    a_d_lambda_0_res = np.interp(parameters["lambda_0_c_d"].value, wavelengths, a_d_res) if parameters[
        "interpolate"].value else a_d_res[utils.find_closest(wavelengths, parameters["lambda_0_c_d"])[1]]
    ...
    if len(b_phy_res) ==0:
        b_phy_res = scattering.b_phy(wavelengths=wavelengths,
                                  C_0=parameters["C_0"],
                                  C_1=parameters["C_1"],
                                  C_2=parameters["C_2"],
                                  C_3=parameters["C_3"],
    ...
    omega_d_lambda_0_res = attenuation.omega_d_lambda_0(x0=parameters["x0"],
                                           x1=parameters["x1"],
                                           x2=parameters["x2"])
    c_d_lambda_0_res = attenuation.estimate_c_d_lambda_0(C_ism=parameters["C_ism"],
                                             C_phy=C_phy,
                                             A_md=parameters["A_md"],
                                             A_bd=parameters["A_bd"],
                                             S_md=parameters["S_md"],
