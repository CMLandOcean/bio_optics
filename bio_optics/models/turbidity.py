...
def petus(Rrs, wavelengths, a=26110, b=604.5, c=0.24, lambda0=645):
    """
    ...
    Args:
        ...
        b: Defaults to 604.5.
        c: Defaults to 0.24.
        lambda0: wavelength for turbidity estimation. Defaults to 645.
...
def chen(Rrs, wavelengths, a=1203.9, b=1.087, lambda0=645):
    """
    ...
    Returns: turbidity [NTU]
    """
    return a * Rrs[find_closest(wavelengths, lambda0)[1]]**b


def hico(Rrs, wavelengths, a=2e6, b=2.7848, lambda0=646):
    """
    ...
    Returns: turbidity [NTU]
    """
    return chen(Rrs, wavelengths, a, b, lambda0)
...
def potes(R, wavelengths, lambda1= 412.5, lambda2=560, a=8.93, b=-6.39):
    """
    Empirical algorithm for turbidity [NTU] estimation as reported in Potes et al. (2018) [1].
