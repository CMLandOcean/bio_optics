...
class OWT():
    ...
    def __init__(self, AVW, Area, NDI, fn_centroids):
        ...
        classInfo = self.load_centroids(fn_centroids)
    ...
    @staticmethod
    def load_centroids(fn = "./data/OWT_centroids.nc"):
        """
        ...
        # fn = "./data/OWT_centroids_refined3a_4a.nc"
        ds = nc.Dataset(fn)
